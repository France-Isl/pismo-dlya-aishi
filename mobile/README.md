...
## Настройка Google Play и цены €7.99
...
3. Установите базовую цену €7.99 и проверьте автоматически рассчитанные локальные цены. Цена задаётся и меняется в Play Console, а не в APK.
...
`€7.99` в коде — только запасная подпись до ответа каталога Play. В рабочем магазине UI получает локализованную цену из `ProductDetails`.
